...
function BoardDetail() {
  ...
  const CallBoardDetailApi = () =>
    axios
      .post(`jjb.jjackbalance.info/boardDetail`, {
        userId: userId,
      })
  ...
  const CallBoardCommentsApi = (userId, userName, inputValue) => {
    return axios
      .post(`jjb.jjackbalance.info/board/comment`, {
        userId: userId,
        userName: userName,
        comment: inputValue,
        time: nowTime,
  ...
  const GetBoardCommentsApi = () => {
    return axios
      .post(`jjb.jjackbalance.info/board/comment/get`, {
        userId: userId,
        userName: userName,
      })
      .then((res) => setComment(res.data));
  ...
  const DeleteBoardMentApi = (userName, id) => {
    axios.delete(`jjb.jjackbalance.info/board/mine/comment/delete`, {
